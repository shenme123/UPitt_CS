...
public class TrieST<Value> {
    ...
    ****************************************************/
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("\nPrint all keys beginning with 's'");
        //print keys with given prefix
        for(String key : st.keysWithPrefix("s"))
            StdOut.println(key + " " + st.get(key));
        
        
        StdOut.println("\nPrint all keys beginning with 'she'");
        //print keys with given prefix
        for(String key : st.keysWithPrefix("she"))
            StdOut.println(key + " " + st.get(key));
        
        
        StdOut.println("\nPrint all keys that match 's..'");
        for(String key : st.keysThatMatch("s.."))
            StdOut.println(key + " " + st.get(key)); 
        
        
        StdOut.println("\nPrint all keys that match 's.e'");
        for(String key : st.keysThatMatch("s.e"))
            StdOut.println(key + " " + st.get(key)); 
        
        
        StdOut.println("\nPrint the longest prefix of 'shell'");
        //print the longest prefix of 'shell'
        StdOut.println(st.longestPrefixOf("shell"));
        
        
        StdOut.println("\nPrint the longest prefix of 'shellsort'");
        //print the longest prefix of 'shellsort'
        StdOut.println(st.longestPrefixOf("shellsort"));
        
        StdOut.println("\nPrint the longest prefix of 'shelters'");
        //print the longest prefix of 'shelters'
        StdOut.println(st.longestPrefixOf("shelters"));
