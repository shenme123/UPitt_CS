...
public class ChangeableGraph {

    public static void main(String[] args) throws Exception {
        BufferedReader infile = new BufferedReader(new FileReader(args[0]));
        EdgeWeightedGraph G = new EdgeWeightedGraph(infile);
//        DepthFirstSearch search = new DepthFirstSearch(G,0);
        ...
        if (opt == 3) {
            ...
            sp = new DijkstraSP(G, v1);
            System.out.printf("(%4.2f)  ", sp.distTo(v2));
            if (sp.hasPathTo(v2)){
...
class EdgeWeightedGraph {
    ...
    public EdgeWeightedGraph(BufferedReader infile) throws Exception {
        this(Integer.parseInt(infile.readLine()));
        int edge = Integer.parseInt(infile.readLine());
        for (int i = 0; i < edge; i++) {
            String[] token = infile.readLine().split("\\s+");
