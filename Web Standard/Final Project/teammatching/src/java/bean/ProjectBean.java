...
public class ProjectBean {
   ...
   public int getPid(String pname){
    ...
    public List getProject(int uid){ 
		String sql = "select a.pid,a.pname,a.teamsize,a.p_idate,a.p_edate,a.issueby,b.grade from PROJECTINFO a,RECMDINFO b where a.pid=b.pid and b.uid="+uid+" order by b.grade desc";
		DBO dbo=new DBO();
		list = new ArrayList();
		dbo.open();
		try{
