                                    ...
                                    <table class="fullwidth" cellpadding="0" cellspacing="0" border="0" height="500px">
										...
										if(list1!=null){
										 ...
										 <td >客户姓名：</td>
											...
											<td><%=list2.get(3).toString() %><input type="radio"name="csex" value="男" checked="checked"> 男 
										...
										<%-- 		<td><%=list2.get(11).toString() %>,<%=list2.get(12).toString() %></td> --%>
											...
											<!-- <td>
						                            <p><input type="checkbox" name="birth_warm"/>生日,
						                            <input type="checkbox" name="mail_sub" />邮件</p></td> -->
											</tr>
											<tr  class="odd">
