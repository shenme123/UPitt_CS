...
<div id="main">
					...
					<div class="pad20">
						...
						<div id="tabs">
							<ul>
						       ...
						       <option value=0>请选选择房型</option>
												...
												<span class="field_desc">客户所订房型</span>
											</p>
                                            <p>
												<label for="sf">预约时间: </label>
						<input class="sf" name="odate" type="text" value="" onclick="SelectDate(this,'yyyy-MM-dd')"
												...
												<span class="field_desc">客户预约时间</span>
											</p>
											<p>
						...
						<select name="rquan" id="rquan" style="WIDTH: 100px" onchange="selectChange(this);">
