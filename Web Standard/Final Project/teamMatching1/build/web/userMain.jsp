<%-- 
    Document   : userMain
    Created on : Dec 5, 2013, 4:21:10 PM
    Author     : xmrui_000
--%>
    ...
    <body>
        <div id="main">
            ...
            <div class="pad20">
                <div id="tabs">
                 <ul>
		<li><a href="#tabs-1">Your Personal Info</a></li>
		...
		<select name="techTag" id="techTag1" style="WIDTH: 250px"  onchange="selectChange_1(this)">
...
out.println("<option value="+list4.get(0).toString()+">"+list4.get(1).toString()+"</option>");}}%>	 </select></p>

           <p><label for="sf">Tech Interest 2: </label>
		<select name="techTag" id="techTag2" style="WIDTH: 250px" onchange="selectChange_2(this)">
        <option selected="selected" value="">-Please Choose the First Your Interest-</option>
		 </select> </p>
         
           <p><label for="sf">Tech Interest 3: </label>
		<select name="techTag" id="techTag3" style="WIDTH: 250px">
			<option selected="selected" value="">-Please Choose the First Your Interest-</option>
		  </select> </p>
