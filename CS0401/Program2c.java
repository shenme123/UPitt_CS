...
try // WE WILL LEARN EXCEPTIONS SOON - PUT ALL YOUR MAIN CODE IN HERE 
{
	...
	String dWordList[] = new String[500];
	...
	String aListS[] = new String [500];
	String aList[] = new String [500];
	int countA = 0;
	String fListS[] = new String [500];
	String fList[] = new String [500];
	int countF = 0;
	String nListS[] = new String [500];
	String nList[] = new String [500];
	int countN = 0;
	...
	String jWordList[] = new String [500];
	int jWordsFound=0;
